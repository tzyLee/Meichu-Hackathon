  ...
  render() {
    ...
    return (
        <React.Fragment>
            ...
            <Grid item xs={4}>
              <Paper style = {{height : '200px', position: 'relative', paddingTop: '10px'}}>
            ...
            <Grid item xs={9}>
              <Paper style = {{height: '300px', position: 'relative', paddingTop: '75px', paddingLeft: '10px', paddingRight: '10px'}}>
                <div style = {{position: 'absolute', top: '5px', left: '20px', fontSize: '30px'}}> Air Quality Analyze </div>
                <LineChart/>
              </Paper>
            </Grid>
            <Grid item xs={3}>
              <Paper style = {{height: '300px', position: 'relative', textAlign: 'center'}}>
